...
@interface JSAssignTecherCell()

@end

@implementation JSAssignTecherCell
...
- (void)createSubviews {
    ...
    [femaleBtn setTitle:@"王丽彩" forState:UIControlStateNormal];
