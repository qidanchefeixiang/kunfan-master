...
@interface DLAddSchoolViewController ()<UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) UITableView *tableView;

@end

@implementation DLAddSchoolViewController
...
- (void)addHeaderView{
    ...
    [titleView changTitle:@"添加校区" andDetail:@"输入校区详情"];
