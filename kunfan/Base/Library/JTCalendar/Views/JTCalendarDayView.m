...
- (void)commonInit
{
    ...
    
    {
        ...
        _textLabel.font = kHBFontEight;//kHBFontEight;//[UIFont systemFontOfSize:[UIFont systemFontSize]];
    }
    
    {
        _sleepImageView = [UIImageView new];
        _sleepImageView.image = [UIImage imageNamed:@"zzz_Icon"];
        [self addSubview:_sleepImageView];
    }
...
- (void)layoutSubviews
{
    ...
    _circleView.frame = CGRectMake(0, 0, sizeCircle/1.5, sizeCircle/1.5);
    _circleView.center = CGPointMake(self.frame.size.width / 2., self.frame.size.height / 2.);
    _circleView.layer.cornerRadius = sizeCircle / 3.;
    ...
    _sleepImageView.frame = CGRectMake(0, 0, 10, 10);
    _sleepImageView.center = CGPointMake(self.frame.size.width / 2., (self.frame.size.height / 2.) +sizeDot * 2.5+5);
