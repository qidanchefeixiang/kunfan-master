...
@interface DLPageViewController ()<UIPageViewControllerDelegate,UIPageViewControllerDataSource>
...
-(KFNavigationTabBar *)navigationTabBar
{
    if (!_navigationTabBar) {
        self.navigationTabBar = [[KFNavigationTabBar alloc] initWithTitles:@[@"代理首页",@"个人中心"]];
...
-(NSArray *)subViewControllers
{
    if (!_subViewControllers) {
        DLHomeViewController *controllerOne = [[DLHomeViewController alloc] init];
        
        DLPersonalViewController *controllerTwo = [[DLPersonalViewController alloc] init];
