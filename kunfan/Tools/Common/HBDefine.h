...
#define KFPhoneColor                                UIColorFromHEX(0x8C9DAA)   //phone
...
#define kHBFontThreeBold17                                [UIFont fontWithName:@"PingFangSC-Semibold" size:17]
#define kHBFontFour                                     [UIFont fontWithName:@"PingFangSC-Regular" size:16]
#define kHBFontFourBold                                     [UIFont fontWithName:@"PingFangSC-Semibold" size:16]
...
#define kHBFontSixMedium                                     [UIFont fontWithName:@"PingFangSC-Medium" size:14]
#define kHBFontSixBold                                       [UIFont fontWithName:@"PingFangSC-Semibold" size:14]
