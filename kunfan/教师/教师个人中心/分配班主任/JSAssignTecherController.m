...
#import "JSAssignTecherCell.h"
#import "JSAssignTecherDetailController.h"
@interface JSAssignTecherController ()<UISearchBarDelegate,UITableViewDataSource, UITableViewDelegate>
...
@implementation JSAssignTecherController
...
- (void)setupLayout {
    ...
    [tableView registerClass:[JSAssignTecherCell class] forCellReuseIdentifier:[JSAssignTecherCell identifier]];
...
- (void)addHeaderView{
    ...
    [titleView changTitle:@"分配班主任" andDetail:@"把学生分配到班主任"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JSAssignTecherCell *cell = [tableView dequeueReusableCellWithIdentifier:[JSAssignTecherCell identifier] forIndexPath:indexPath];
    if (!cell) {
        cell = [[JSAssignTecherCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:[JSAssignTecherCell identifier]];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JSAssignTecherDetailController *vc = [[JSAssignTecherDetailController alloc]init];
