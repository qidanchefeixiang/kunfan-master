//
//  JSAssignTecherDetailController.m
//  kunfan
//
...
#import "JSAssignTecherDetailCell.h"

#define NAVBAR_CHANGE_POINT 50

@interface JSAssignTecherDetailController ()<UISearchBarDelegate,UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) UITableView *tableView;

@end

@implementation JSAssignTecherDetailController
...
- (void)setupLayout {
    ...
    [tableView registerClass:[JSAssignTecherDetailCell class] forCellReuseIdentifier:[JSAssignTecherDetailCell identifier]];
...
- (void)addHeaderView{
    ...
    [titleView changTitle:@"选择班主任" andDetail:@"选择想要分配到的班主任"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    //设置 添加好友
    JSAssignTecherDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:[JSAssignTecherDetailCell identifier] forIndexPath:indexPath];
    if (!cell) {
        cell = [[JSAssignTecherDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:[JSAssignTecherDetailCell identifier]];
    }
